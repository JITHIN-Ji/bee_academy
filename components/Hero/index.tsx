        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap items-center">
              ...
              >
                ...
                <div className="flex flex-col items-start space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                  ...
                  >
                    ...
                    <Link
                      href="/courses"
                      className="inline-block rounded-sm border-2 border-primary px-8 py-4 text-base font-semibold text-primary duration-300 ease-in-out hover:bg-primary/5"
                    >
                      Explore Courses
                    </Link>
                </div>
            ...
            <div className="w-full px-4 md:w-1/2">
              ...
              >
                <div className="relative h-[480px] overflow-hidden rounded-2xl bg-gradient-to-br from-primary/20 to-pink-200 shadow-xl">
                  {/* Desktop Image */}
                  <Image
