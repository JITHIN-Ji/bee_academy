    ...
    <>
      <style jsx global>{`
        ...
        .btn-primary:hover {
          ...
          background: linear-gradient(135deg, #5457e5, #7c3aed);
        }
        ...
        .hero-image-wrapper {
          background: linear-gradient(135deg, rgba(139, 92, 246, 0.18), rgba(236, 72, 153, 0.15));
          box-shadow: 0 24px 60px rgba(99, 102, 241, 0.18), 0 8px 24px rgba(0,0,0,0.08);
        }
      `}</style>

      <section
        id="home"
        className="relative z-10 overflow-hidden bg-gradient-to-br from-slate-50 via-indigo-50/60 to-purple-50/70"
        style={{
          /* stripe (~32px) + navbar (~72px) = 104px. Add generous breathing room */
          paddingTop: "clamp(100px, 8vw, 160px)",
        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap items-center overflow-hidden">
            ...
            <div className="w-full px-4 md:w-1/2 mb-8 md:mb-0">
              ...
              >
                <div className="mb-5">
                  <span className="badge-pill inline-block rounded-full px-4 py-2">
                    Bee Academy — Fashion &amp; Creative Programs
                  </span>
                </div>

                <h1 className="mb-5 text-[2.6rem] font-extrabold leading-[1.15] text-gray-900 sm:text-5xl md:text-[3.4rem]">
                  Focused on{" "}
                  <span className="block">Fashion Design,</span>
                  <span
                    style={{
                ...
                <p
                  ...
                  style={{ color: "#64748b", fontFamily: "'DM Sans', sans-serif", maxWidth: "480px" }}
                >
                  Specializing in fashion design education, Bee Academy offers
                  a wide range of creative courses — taught by industry experts
                  to build real, practical skills.
                </p>

                <div className="flex flex-col items-start space-y-3 sm:flex-row sm:space-x-4 sm:space-y-0">
                  <Link href="/contact" className="btn-primary rounded-lg px-8 py-3.5 text-sm font-semibold text-white">
                    Enroll Now
                  </Link>
                  <Link href="/courses" className="btn-outline inline-block rounded-lg px-8 py-3.5 text-sm font-semibold">
                    Explore Courses
                  </Link>
                </div>
              </div>
            ...
            <div className="w-full px-4 md:w-1/2">
              ...
              >
                <div className="hero-image-wrapper relative h-[480px] overflow-hidden rounded-3xl">
                  <Image
          ...
          <svg width="450" height="556" viewBox="0 0 450 556" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
              ...
              <radialGradient id="paint1_radial_25:217" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(17.9997 182) rotate(90) scale(18)">
                <stop offset="0.145833" stopColor="#6366f1" stopOpacity="0" /><stop offset="1" stopColor="#6366f1" stopOpacity="0.08" />
              </radialGradient>
              ...
              <linearGradient id="paint4_linear_25:217" x1="184.521" y1="182.159" x2="184.521" y2="448.882" gradientUnits="userSpaceOnUse">
                <stop stopColor="#6366f1" /><stop offset="1" stopColor="white" stopOpacity="0" />
              </linearGradient>
              <linearGradient id="paint5_linear_25:217" x1="356" y1="110" x2="356" y2="470" gradientUnits="userSpaceOnUse">
                <stop stopColor="#a855f7" /><stop offset="1" stopColor="white" stopOpacity="0" />
              </linearGradient>
          ...
          <svg width="364" height="201" viewBox="0 0 364 201" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
              <linearGradient id="paint0_linear_25:218" x1="184.389" y1="69.2405" x2="184.389" y2="212.24" gradientUnits="userSpaceOnUse">
                <stop stopColor="#6366f1" stopOpacity="0" /><stop offset="1" stopColor="#6366f1" />
              </linearGradient>
              ...
              <linearGradient id="paint3_linear_25:218" x1="93.8507" y1="67.2674" x2="89.9278" y2="210.214" gradientUnits="userSpaceOnUse">
                <stop stopColor="#a855f7" stopOpacity="0" /><stop offset="1" stopColor="#a855f7" />
              </linearGradient>
