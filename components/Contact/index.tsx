                  ...
                  <div className="w-full px-4 md:w-1/2">
                    <div className="mb-8">
                      ...
                      >
                        ...
                        <option>Fashion Design Diploma</option>
                        <option>Advanced Fashion Design</option>
                  ...
                  <div className="w-full px-4">
                    <div className="mb-8">
                      ...
                      <textarea
                        name="message"
                        rows={5}
                        placeholder="Why are you interested in fashion design? Any experience or skills?"
