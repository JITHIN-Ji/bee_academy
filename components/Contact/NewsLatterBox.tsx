    ...
    >
      ...
      <div>
        ...
        <p className="dark:text-body-color-dark text-center text-base leading-relaxed text-body-color">
          Fast access guaranteed. We&rsquo;ll email the guide to you immediately.
        </p>
      </div>
      ...
      <div className="mt-12 border-t border-white/10 pt-8">
        ...
        <div className="space-y-6">
          <div className="flex gap-4">
            <div className="flex-shrink-0">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M3 9C3 5.13401 6.13401 2 10 2C13.866 2 17 5.13401 17 9C17 14.25 10 22 10 22S3 14.25 3 9Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-primary"/>
                <circle cx="10" cy="9" r="2.5" stroke="currentColor" strokeWidth="2" className="text-primary"/>
              </svg>
            </div>
            <div>
              <p className="text-sm font-semibold text-dark dark:text-white">Address</p>
          ...
          <div className="flex gap-4">
            <div className="flex-shrink-0">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M3 9L10.89 5.26C11.5475 4.89989 12.4525 4.89989 13.11 5.26L21 9M5 10V19C5 20.1046 5.89543 21 7 21H17C18.1046 21 19 20.1046 19 19V10" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-primary"/>
              </svg>
            </div>
            <div>
              <p className="text-sm font-semibold text-dark dark:text-white">Phone</p>
              <a href="tel:9544111189" className="text-body-color dark:text-body-color-dark hover:text-primary dark:hover:text-primary text-base transition duration-300">
                +91 9544111189
              </a>
            </div>
          </div>
