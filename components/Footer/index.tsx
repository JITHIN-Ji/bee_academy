...
const Footer = () => {
  return (
    <>
      <footer
        className="wow fadeInUp relative z-10 bg-gradient-to-br from-[#e8f4fd] to-[#dbeeff] text-gray-800 pt-16 md:pt-20 lg:pt-24 rounded-md"
        data-wow-delay=".1s"
      >
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="mb-9 text-base leading-relaxed text-gray-600">
                  Master the art of fashion design with our comprehensive courses and hands-on training led by industry experts.
                </p>
                <div className="flex items-center">
                    ...
                    aria-label="Facebook"
                    className="mr-6 text-gray-600 duration-300 hover:text-gray-900"
                  >
                    ...
                    <a href="https://www.instagram.com/bee_academy_chemmad/"
                    target="_blank"
                    rel="noopener noreferrer"
                  ...
                  >
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M7.75 2C4.574 2 2 4.574 2 7.75v8.5C2 19.426 4.574 22 7.75 22h8.5C19.426 22 22 19.426 22 16.25v-8.5C22 4.574 19.426 2 16.25 2h-8.5zm0 2h8.5A3.75 3.75 0 0 1 20 7.75v8.5A3.75 3.75 0 0 1 16.25 20h-8.5A3.75 3.75 0 0 1 4 16.25v-8.5A3.75 3.75 0 0 1 7.75 4zm4.25 2.5A5.25 5.25 0 1 0 17.25 12 5.256 5.256 0 0 0 12 6.5zm0 2A3.25 3.25 0 1 1 8.75 12 3.254 3.254 0 0 1 12 8.5zm5.5-.75a1 1 0 1 0 1 1 1 1 0 0 0-1-1z"/>
                    </svg>
                  </a>
                </div>
              </div>
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  <li>
                    <a href="/" className="mb-4 inline-block text-base text-gray-600 duration-300 hover:text-gray-900">
                      Home
                    </a>
                  </li>
                  <li>
                    <a href="/about" className="mb-4 inline-block text-base text-gray-600 duration-300 hover:text-gray-900">
                      About
                    </a>
                  </li>
                  <li>
                    <a href="/courses" className="mb-4 inline-block text-base text-gray-600 duration-300 hover:text-gray-900">
                      Courses
                    </a>
                  </li>
                  <li>
                    <a href="/tutors" className="mb-4 inline-block text-base text-gray-600 duration-300 hover:text-gray-900">
                      Tutors
                    </a>
                  </li>
                </ul>
            ...
            <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
              <div className="mb-12 lg:mb-16">
                ...
                <ul>
                  <li>
                    <a href="/events" className="mb-4 inline-block text-base text-gray-600 duration-300 hover:text-gray-900">
                      Events
                    </a>
                  </li>
                  <li>
                    <a href="/contact" className="mb-4 inline-block text-base text-gray-600 duration-300 hover:text-gray-900">
                      Contact
                    </a>
                  </li>
                  <li>
            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-3/12">
              <div className="mb-12 lg:mb-16">
                ...
                <div className="space-y-6">
                  <div>
                    <p className="mb-2 text-sm font-semibold text-gray-800">Phone</p>
                    <a href="tel:9544111189" className="text-base text-gray-600 duration-300 hover:text-gray-900">
                      +91 9544111189
                    </a>
                  </div>
                  <div>
                    <p className="mb-2 text-sm font-semibold text-gray-800">Address</p>
          ...
          <div className="py-8">
            <p className="text-center text-base text-gray-500">
              © 2026 Bee Academy. All rights reserved.
            </p>
          </div>
        </div>
